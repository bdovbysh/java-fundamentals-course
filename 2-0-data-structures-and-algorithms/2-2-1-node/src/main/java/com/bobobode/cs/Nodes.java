...
public class Nodes {
    ...
    public static <T> Node<T> pairOf(T firstElement, T secondElement) {
        Node firstNode = create(firstElement);
        firstNode.setNext(create(secondElement));
        return firstNode;
    }
    ...
    public static <T> Node<T> closedPairOf(T firstElement, T secondElement) {
        Node firstNode = pairOf(firstElement, secondElement);
    ...
    public static <T> Node<T> chainOf(T... elements) {
       Node firstNode = create(elements[0]);
       Node currentNode = firstNode;
       for (int i = 1; i < elements.length; i++) {
           Node nextNode = create(elements[i]);
