...
public class CrazyGenerics {
    ...
    static class CollectionUtil {
         ...
         * @param <T>          entity type
         * @return true if entities list contains target entity more than oncez
         */
        ...
        public static void swap(List<?> elements, int i, int j) {
            ...
            typedListSwap(elements, i, j);
        }

        private static <T> void typedListSwap(List<T> elements, int i, int j) {
