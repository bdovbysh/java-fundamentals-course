...
public class CrazyLambdas {
    ...
    public static Function<BigDecimal, String> toDollarStringFunction() {
        return decimal -> String.format("$%s",decimal);
    }
    ...
    public static Supplier<IntUnaryOperator> nMultiplyFunctionSupplier(int n) {
       return () -> intSupplier -> intSupplier * n;
    }
    ...
    public static UnaryOperator<Function<String, String>> composeWithTrimFunction() {
        return unaryFunc -> unaryFunc.compose(String::trim);
    }
    ...
    public static BiFunction<IntUnaryOperator, IntPredicate, IntUnaryOperator> functionToConditionalFunction() {
        return (intUnaryOperator, intPredicate) ->
                intVariable -> intPredicate.test(intVariable) ? intUnaryOperator.applyAsInt(intVariable) : intVariable;
    }
